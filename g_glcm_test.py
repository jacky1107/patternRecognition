...
def process_image(data):
    ...
    for method, img in enumerate(space):
        ...
        hists.append([Asm0, Con0, Idm0, Eng0])
        hists.append([Asm1, Con1, Idm1, Eng1])
        hists.append([Asm2, Con2, Idm2, Eng2])
        hists.append([Asm3, Con3, Idm3, Eng3])
...
pickle_out = open("p_glcm.pickle", "wb")
